...
-- Inserir accounts
INSERT INTO tb_account (id, email, password, first_name, last_name) VALUES (1, 'user1@example.com', 'password1', 'User1', 'LastName1');
INSERT INTO tb_account (id, email, password, first_name, last_name) VALUES (2, 'admin@example.com', 'password2', 'Admin', 'LastName2');
